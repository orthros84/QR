...
class SmsView extends StatelessWidget {
  ...
  const SmsView({Key? key, required this.data}) : super(key: key);
...
class MailView extends StatelessWidget {
  ...
  const MailView({Key? key, required this.data}) : super(key: key);
...
class ContactView extends StatelessWidget {
  ...
  const ContactView({Key? key, required this.data}) : super(key: key);
...
class TeleView extends StatelessWidget {
  ...
  const TeleView({Key? key, required this.data}) : super(key: key);
...
class UrlView extends StatelessWidget {
  ...
  const UrlView({Key? key, required this.data}) : super(key: key);
