...
class FormData extends StatelessWidget {
  ...
  const FormData({Key? key, required this.data}) : super(key: key);
...
class SmsFormData extends StatelessWidget {
  ...
  SmsFormData({Key? key, required this.data}) : super(key: key);
...
class MailFormData extends StatelessWidget {
  ...
  MailFormData({Key? key, required this.data}) : super(key: key);
...
class ContactFormData extends StatelessWidget {
  ...
  ContactFormData({Key? key, required this.data}) : super(key: key);
...
class TeleFormData extends StatelessWidget {
  ...
  TeleFormData({Key? key, required this.data}) : super(key: key);
...
class UrlFormData extends StatelessWidget {
  ...
  UrlFormData({Key? key, required this.data}) : super(key: key);
...
class TextFormData extends StatelessWidget {
  ...
  TextFormData({Key? key, required this.data}) : super(key: key);
